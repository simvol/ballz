...
let canvas = document.getElementById('canvas'), ctx = canvas.getContext('2d'), cWidth = canvas.clientWidth, cHeight = canvas.clientHeight, 
//used to erase aiming line while mouse is moving
imageData = null, 
//class implementing drawing functions
painter = new Painter(ctx), mover = null, squaresPerLine = 7, 
//distance between squares
squareMargin = 10, squareSize = (cWidth / squaresPerLine) - (squareMargin * 1.1), 
...
numberOfBalls = null, level = null, step = 1, ballsIncrement = 5, levelIncrement = 5, 
//Prepare grid
